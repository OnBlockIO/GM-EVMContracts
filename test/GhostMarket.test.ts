...
describe("GhostMarket Token Test", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Should be upgradable", async function () {
      ...
      const upgraded_token_proxy: GhostMarketToken = <GhostMarketToken>await upgrades.upgradeProxy(gm_proxy.address, newTokenProxy)
  ...
  describe("Contract", function () {
    ...
    it("Transfer tokens to another wallet", async () => {
        ...
        await expect(gm_proxy.transfer(addrs[3].address, '9999999999999999999999999'))
    ...
    it("Approve/Allowance/TransferFrom", async () => {
        ...
        await expect(gm_proxy.transferFrom(owner.address, addrs[2].address, 2000))
